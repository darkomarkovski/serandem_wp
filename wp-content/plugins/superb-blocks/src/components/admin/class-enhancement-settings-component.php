...
?>
        ...
        <div class="superbaddons-editor-settings-enhancements-wrapper">
            ...
            <?php new InputCheckbox('superbaddons-enhancement-hiders-input', GutenbergEnhancementsController::HIDERS_KEY, __("Hide Block Settings", "superb-blocks"), __("When this setting is enabled, all blocks will receive a hide block settings panel where you can decide whether or not certain blocks should be hidden on specific screens and devices.", "superb-blocks"), $this->Settings[GutenbergEnhancementsController::HIDERS_KEY]); ?>
        </div>
<?php
    }
}
