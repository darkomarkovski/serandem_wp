        ...
        <div class="superbaddons-admindashboard-content-box-large superbaddons-admindashboard-general-intro" style="background-image:url(<?= esc_url(SUPERBADDONS_ASSETS_PATH . '/img/asset-medium-dashboardheader.jpg'); ?>);">
            <div class="superbaddons-admindashboard-content-box-large-inner">
                ...
                <p class="superbaddons-element-text-xxs superbaddons-element-text-gray">
                    <?= esc_html__("Say goodbye to countless hours lost on trial and error. No design or coding skills required. Unlock more than 500 sections, themes and blocks with one click.", "superb-blocks"); ?>
                </p>
            </div>
        </div>
            ...
            <div class="superbaddons-admindashboard-sidebarlayout-left">
                ...
                new ContentBoxLarge(
                    array(
                        ...
                        "description" => __("Unleash the full potential of Elementor with Superb Addons. Create pixel-perfect designs and take your website-building skills to the next level with our seamless integration that gives you access to 250 Elementor sections and elements.", "superb-blocks"),
